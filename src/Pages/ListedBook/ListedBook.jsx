...
const ListedBooks = () => {
 ...
 const [readBookSort , setReadBookSort] = useState(readBooks);
 const [wishlistSort , setWishlistSort] = useState(wishlists);

  const handelSelectorBtn = (sortName) => {
    if (sortName === 'rating') {
    ...
    <section className="my-10">
      ...
      <details className="dropdown mx-auto flex justify-center w-fit my-10">
        ...
        <ul className="p-2  shadow menu dropdown-content z-[1] bg-base-100 rounded-box w-52">
          ...
          <li onClick={() => handelSelectorBtn('numberOfPages')}>
            <a>Number of pages</a>
          </li>
          <li onClick={() => handelSelectorBtn('publisherYear')}>
            <a>Publisher year</a>
          </li>
        </ul>
      </details>
              ...
              <div className="space-y-3 lg:flex-1">
                ...
                <div className="flex lg:items-center flex-col lg:flex-row gap-4">
                  ...
                  <div>
                    <Link
                      to={`/book/${book?.bookId}`}
                      className="relative cursor-pointer inline-flex items-center justify-center px-2 lg:px-6 py-2 overflow-hidden font-mono font-medium tracking-tighter text-white bg-[#23BE0A] rounded-full group"
                    >
